    ...
    public static ArrayList<Hotel> ITEMS = new ArrayList<Hotel>(){
        {
            ...
            add(new Hotel("Tan Son Nhat Saigon Hotel", "100.000 ~ 300.000", "202 Hoang Van Thu, Ward 9, Phu Nhuan District, Ho Chi Minh City, Vietnam","a","0362417182","Khách sạn Tân Sơn Nhất nằm trong hệ thống khách sạn gần sân bay Tân Sơn Nhất với chất lượng dịch vụ tiêu chuẩn 5 sao. Quá trình phục vụ chuyên nghiệp đã khẳng định được vị thế của khách sạn này trong lòng du khách trong và ngoài nước. Sở hữu vị trí đắc địa, điểm lưu trú này đã tồn tại, phát triển và phục vụ hàng trăm nghìn lượt khách, đem lại sự thuận tiện cho những chuyến đi đến thành phố Hồ Chí Minh của khách du lịch.",new ArrayList<Room>(){{
                // Rooms
                add(new Room("A101","Phòng đôi có view đẹp ","",300000,2));
                add(new Room("A101","Phòng đôi có view đẹp ","",200000,2));
                add(new Room("A101","Phòng đôi có view đẹp ","",250000,2));
            ...
            add(new Hotel("Cochin Sang Hotel", "100.000 ~ 300.000", "28-30 Nguyen An Ninh, Ben Thanh Ward, District 1, Ho Chi Minh City, Vietnam","a","0362417182","Khách sạn bình dân này có nhiều nhà hàng xung quanh, cách chợ Bến Thành 2 phút đi bộ, Dinh Độc Lập 13 phút đi bộ và Sân bay Quốc tế Tân Sơn Nhất 7 km.",
                    new ArrayList<Room>(){{
                        // Rooms
                        add(new Room("A101","Phòng đôi có view đẹp ","",300000,2));
                        add(new Room("A101","Phòng đôi có view đẹp ","",200000,2));
            ...
            add(new Hotel("Adora Art Hotel", "100.000 ~ 300.000", "189-191 Ly Tu Trong, Ben Thanh Ward, District 1, Ho Chi Minh City, Vietnam","a","0362417182","Khách sạn Sunflower Central bao gồm 72 phòng ngủ được thiết kế đầy sang trọng và tinh tế đạt tiêu chuẩn chất lượng 3 sao. Tông màu chủ đạo của khách sạn là màu vàng cùng nội thất cao cấp tạo nên một không gian ấm áp mà đầy thanh lịch, quý phái. ", new ArrayList<Room>(){{
                // Rooms
                add(new Room("A101","Phòng đôi có view đẹp ","",300000,2));
                add(new Room("A101","Phòng đôi có view đẹp ","",200000,2));
                add(new Room("A101","Phòng đôi có view đẹp ","",250000,2));
